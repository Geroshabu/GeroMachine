...
namespace GeroMachineTest
{
	public class TransitionTest
	{
		public class CreationTest
		{
			...
			[Theory(DisplayName = "Transition:Creation:コンストラクタの単純な値初期化テスト")]
			...
			[Theory(DisplayName = "Transition:Creation:内部遷移のインスタンス生成テスト")]
		...
		public class RegularInstanceTest
		{
			...
			[Fact(DisplayName = "Transition:RegularInstance:Executeメソッドのテスト")]
		...
		public class NoTransitionMethodInstanceTest
		{
			...
			[Fact(DisplayName = "Transition:NoTransitionMethodInstance:Executeメソッドのテスト")]
			public void TestExecuteMethod()
			{
				// Prepare datas
				State expected_result = setting_NextState;
